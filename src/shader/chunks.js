...
chunks.getBoneMatrix = ShaderChunk.create({
    code: [
        "#ifdef USE_BONES",
        "mat4 getBoneMatrix_mat;",
        "mat4 getBoneMatrix() {",
        "    mat4 result = boneWeight.x * composeMat4(getBoneMatrix_mat, bonePosition[int(boneIndex.x)], boneScale[int(boneIndex.x)], boneRotation[int(boneIndex.x)]);",
        "    result = result + boneWeight.y * composeMat4(getBoneMatrix_mat, bonePosition[int(boneIndex.y)], boneScale[int(boneIndex.y)], boneRotation[int(boneIndex.y)]);",
        "    #if BONE_WEIGHTS > 2",
        "    result = result + boneWeight.z * composeMat4(getBoneMatrix_mat, bonePosition[int(boneIndex.z)], boneScale[int(boneIndex.z)], boneRotation[int(boneIndex.z)]);",
        "    #endif",
        "    #if BONE_WEIGHTS > 3",
        "    result = result + boneWeight.w * composeMat4(getBoneMatrix_mat, bonePosition[int(boneIndex.w)], boneScale[int(boneIndex.w)], boneRotation[int(boneIndex.w)]);",
        "    #endif",
        "    return result;",
        "}",
        "#endif",
